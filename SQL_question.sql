...
select t."KODE", t."TANGGAL", p."NAMA" as "NAMA PELANGGAN", b."NAMA" as "NAMA BARANG", t."JUMLAH_BARANG" as JUMLAH, b."HARGA" as "HARGA SATUAN", (b."HARGA" * t."JUMLAH_BARANG") as TOTAL from transaksi as t join barang as b on b."KODE" = t."KODE_BARANG" join pelanggan as p on p."KODE" = t."KODE_PELANGGAN" order by p."NAMA", t."TANGGAL";
select p."NAMA" as "NAMA PELANGGAN", sum(t."JUMLAH_BARANG") as JUMLAH, sum(t."JUMLAH_BARANG" * b."HARGA") as "TOTAL HARGA" from transaksi as t join barang as b on b."KODE" = t."KODE_BARANG" join pelanggan as p on p."KODE" = t."KODE_PELANGGAN" group by p."NAMA" order by p."NAMA";